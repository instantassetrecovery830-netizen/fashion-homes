  ...
  return (
    <div className="min-h-screen bg-luxury-cream pt-24 pb-24 animate-fade-in">
      ...
      <div className="max-w-7xl mx-auto px-6 mb-20 text-center">
        <span className="text-xs font-bold uppercase tracking-[0.3em] text-luxury-gold mb-4 block">{content.subtitle}</span>
        <h1 className="text-5xl md:text-7xl font-serif italic mb-6">{content.title}</h1>
